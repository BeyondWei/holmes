...
import com.shuzheng.holmes.common.utils.OSUtils;
...
public final class Constants {
    ...
    /**
     * SERVER directory registered in zookeeper
     */
    public static final String ZOOKEEPER_HOLMES_SERVER = "/holmes/server";

    /**
     * AGENT directory registered in zookeeper
     */
    public static final String ZOOKEEPER_HOLMES_AGENT = "/holmes/agent";
    ...
    public static final String AGENT_MAX_CPULOAD_AVG = "agent.max.cpuload.avg";

    public static final String AGENT_RESERVED_MEMORY = "agent.reserved.memory";

    public static final String SERVER_MAX_CPULOAD_AVG = "server.max.cpuload.avg";

    public static final String SERVER_RESERVED_MEMORY = "server.reserved.memory";
     ...
     * SERVER cpu load
     */
    public static final int DEFAULT_SERVER_CPU_LOAD = Runtime.getRuntime().availableProcessors() * 2;

    /**
     * SERVER reserved memory
     */
    public static final double DEFAULT_SERVER_RESERVED_MEMORY = OSUtils.totalMemorySize() / 10;

    /**
     * AGENT cpu load
     */
    public static final int DEFAULT_AGENT_CPU_LOAD = Runtime.getRuntime().availableProcessors() * 2;

    /**
     * AGENT reserved memory
     */
    public static final double DEFAULT_AGENT_RESERVED_MEMORY = OSUtils.totalMemorySize() / 10;
